...
class Transformation:
    ...
    def create_roi_and_objects(self):
...
if __name__ == "__main__":
    ...
    transform = Transformation(debug=False, output_dir="output")
    transform.load_image(img)
    transform.white_balance()
    transform.grayscale_conversion()
    transform.apply_gaussian_blur()
    transform.create_masks()
    transform.create_roi_and_objects()
    transform.pseudolandmarks()
    transform.color_histogram()
    # transform.display_final_images()
